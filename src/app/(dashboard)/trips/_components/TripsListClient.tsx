...
export default function TripsListClient({ initialTrips }: TripsListClientProps) {
  ...
  // Load trips helper for refreshes
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        ...
        <Button 
          ...
          className="rounded-xl bg-[oklch(0.70_0.08_40)] text-white hover:bg-[oklch(0.70_0.08_40)]/90 gap-1.5 shadow-md shadow-rose-100 cursor-pointer"
        >
          <Plus size={18} />
          Buat Trip
        </Button>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-3xl border border-[oklch(0.90_0.008_70)] p-12 text-center text-[oklch(0.48_0.01_40)] space-y-4">
          ...
          <Button 
            ...
            className="rounded-xl bg-[oklch(0.70_0.08_40)] text-white hover:bg-[oklch(0.70_0.08_40)]/90 cursor-pointer"
          >
            Buat Trip Pertama
          </Button>
        </div>
          ...
          {trips.map((trip) => (
            <Card key={trip.id} className="group rounded-3xl border-[oklch(0.90_0.008_70)] shadow-sm bg-white overflow-hidden flex flex-col justify-between hover:shadow-md transition-all">
              <div className="relative h-44 bg-gradient-to-tr from-orange-200 to-amber-100">
                ...
                {/* Mode Tag */}
                <div className="absolute top-4 left-4 bg-white/95 backdrop-blur px-2.5 py-1 rounded-full text-[10px] font-bold text-[oklch(0.70_0.08_40)] shadow-sm uppercase tracking-wider">
              ...
              <CardContent className="p-5 flex-1 flex flex-col justify-between gap-4">
                <div className="space-y-1">
                  <h3 className="font-heading font-extrabold text-base text-[oklch(0.22_0.01_40)] leading-snug group-hover:text-[oklch(0.70_0.08_40)] transition-colors">
                    {trip.name}
                  </h3>
                ...
                <div className="pt-3 border-t border-[oklch(0.90_0.008_70)] flex items-center justify-between gap-3">
                  ...
                  <Link href={`/trips/${trip.id}`}>
                    <Button size="sm" className="rounded-lg bg-[oklch(0.70_0.08_40)] text-white hover:bg-[oklch(0.70_0.08_40)]/90 text-xs font-semibold px-3 py-1.5 shadow-sm shadow-rose-50 cursor-pointer">
                      Buka Rencana
                    </Button>
                  </Link>
                </div>
