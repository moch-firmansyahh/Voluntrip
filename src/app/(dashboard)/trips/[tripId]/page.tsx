      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="rounded-3xl border-[oklch(0.90_0.008_70)] shadow-sm bg-white overflow-hidden">
          <CardContent className="p-5 flex items-center justify-between">
            ...
            <div className="w-10 h-10 rounded-xl bg-orange-50 flex items-center justify-center text-[oklch(0.64_0.22_30)]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <Link href={`/trips/${tripId}/rundown`} className="group block">
              <Card className="rounded-3xl border-[oklch(0.90_0.008_70)] shadow-sm bg-white hover:shadow-md transition-all p-6 space-y-4">
                ...
                <div className="flex items-center gap-1 text-xs font-semibold text-[oklch(0.64_0.22_30)] pt-2 group-hover:translate-x-1 transition-transform">
            ...
            <Link href={`/trips/${tripId}/expenses`} className="group block">
              <Card className="rounded-3xl border-[oklch(0.90_0.008_70)] shadow-sm bg-white hover:shadow-md transition-all p-6 space-y-4">
                ...
                <div>
                  <h4 className="font-bold text-base text-[oklch(0.22_0.01_40)] group-hover:text-[oklch(0.58_0.16_185)] transition-colors">
                    Budget & Pengeluaran
                  </h4>
                  <p className="text-xs text-[oklch(0.48_0.01_40)] mt-1 leading-relaxed">
                ...
                <div className="flex items-center gap-1 text-xs font-semibold text-[oklch(0.58_0.16_185)] pt-2 group-hover:translate-x-1 transition-transform">
            ...
            <div className="space-y-3 pt-2">
              <Button
                ...
                className={`w-full rounded-xl text-xs h-10 font-medium ${
                  trip.is_public 
                    ? 'border-[oklch(0.90_0.008_70)] hover:bg-orange-50/50 text-[oklch(0.64_0.22_30)]' 
                    : 'bg-[oklch(0.64_0.22_30)] text-white hover:bg-[oklch(0.64_0.22_30)]/90 shadow-sm shadow-orange-100'
                }`}
