    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        ...
        <Button 
          ...
          className="rounded-xl bg-[oklch(0.70_0.08_40)] text-white hover:bg-[oklch(0.70_0.08_40)]/90 gap-1.5 shadow-md shadow-rose-100"
        >
          <Plus size={18} />
          Buat Trip
        </Button>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-3xl border border-[oklch(0.90_0.008_70)] p-12 text-center text-[oklch(0.48_0.01_40)] space-y-4">
          ...
          <Button 
            ...
            className="rounded-xl bg-[oklch(0.70_0.08_40)] text-white hover:bg-[oklch(0.70_0.08_40)]/90"
          >
            Buat Trip Pertama
          </Button>
        </div>
              ...
              <CardContent className="p-5 flex-1 flex flex-col justify-between gap-4">
                ...
                <div className="pt-3 border-t border-[oklch(0.90_0.008_70)] flex items-center justify-between gap-3">
                  ...
                  <Link href={`/trips/${trip.id}`}>
                    <Button size="sm" className="rounded-lg bg-[oklch(0.70_0.08_40)] text-white hover:bg-[oklch(0.70_0.08_40)]/90 text-xs font-semibold px-3 py-1.5 shadow-sm shadow-rose-50">
                      Buka Rencana
                    </Button>
                  </Link>
                </div>
